...
function ServiceBlocks() {
    ...
    useEffect(() => {
        const svgContainers = document.querySelectorAll(".n_service_block .icon")
        ...
        const svgElements = document.querySelectorAll('.n_service_block .icon svg');
        svgElements.forEach(function (svgElement) {
            svgElement.setAttribute('stroke', svgStroke);
        })

        const svgLines = document.querySelectorAll(".n_service_block .line svg")
    ...
    return (
        <div className={"n_service_container"}>
            ...
            <div className={"n_service_blocks"}>
                <ServiceItem
